...
public class PCRotation : MonoBehaviour
{
    ...
    {
        if ((lastInput == null || lastInput != pcReferences.pcInputs.MovementInput) && pcReferences.pcInputs.MovementInput != Vector3.zero)
        {
            lastInput = pcReferences.pcInputs.MovementInput;
            direction = pcReferences.pcInputs.MovementInput;
            SetRotation();
        }
    }
